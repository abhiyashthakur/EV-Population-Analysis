...
echo ""
echo "Current clean commit history:"
git log --oneline HEAD
echo ""
echo "Note: The core rewritten history has 2 commits (initial + license)."
echo "Additional commits above are documentation added after history rewrite."
echo ""
echo "========================================="
